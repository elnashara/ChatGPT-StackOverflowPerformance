...
problem = "p6_auto_removingduplicates_strategy"
output = "p6_auto_execution_times.csv"
                    ...
                    if code_start_index > 0: 
                        ...
                        for size in sizes:
                            ...
                            for i in range(versions):
                                ...
                                time_res = timeit.timeit(lambda: funcImp1(lst), number=100)
