...
with open('c1.2_execution_times.csv', mode='a', newline='') as file:
    ...
    for size in sizes:
        ...
        writer.writerow([size, 'C1_removingduplicates_strategy_chatgpt_prompts1', min_time1, max_time1, avg_time1])
        writer.writerow([size, 'C1_removingduplicates_strategy_chatgpt_prompts2', min_time2, max_time2, avg_time2])
        writer.writerow([size, 'C1_removingduplicates_strategy_chatgpt_prompts3', min_time3, max_time3, avg_time3])
